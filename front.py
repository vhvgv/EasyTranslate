...
translated_text = translator.translate("Hello", src='en', dest='ta').text
...
icon = tk.PhotoImage(file="C:\\Users\\visha\\Downloads\\real-time-voice-translator-main\\real-time-voice-translator-main\\icon.png")
